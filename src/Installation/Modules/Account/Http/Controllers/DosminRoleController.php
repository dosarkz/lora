...
namespace Dosarkz\Lora\Modules\Role\Http\Controllers;

use Dosarkz\Lora\Controllers\ModuleController;
use Dosarkz\Lora\Modules\Role\Http\Requests\StoreRoleRequest;
use Dosarkz\Lora\Modules\Role\Http\Requests\UpdateRoleRequest;
