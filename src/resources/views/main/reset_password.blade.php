...
@section('title')
    {{trans('admin::base.reset_password')}}
@endsection

@section('content')
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">{{trans('admin::base.reset_password')}}</h3>
        </div>
                    ...
                    <div class="form-group">
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('/admin/reset-password') }}">
                            ...
                            <div class="cab-btn-wrap">
                                <button type="submit" class="cab-btn">{{trans('admin::base.reset_password')}}</button>
                            </div>
